...
// Or if the year is divisble by 4 and is not divisble by 100 then its a leap year
...
let fahrenheit = 96; // Convert this to Celsius and print the result.
...
let number = 0; // Determine the sign of this number.
let sign;
if (number > 0) {
  sign = "positive";
} else if (number < 0) {
